...
project = u'SvAnna'
copyright = u'2025, Daniel Danis, Peter N Robinson'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'LICENSE','DESCRIPTION']
...
man_pages = [
    (master_doc, 'SvAnna', u'SvAnna Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SvAnna', u'SvAnna Documentation',
     author, 'SvAnna', 'Structural Variant Annotation and Analysis',
     'Miscellaneous'),
]
