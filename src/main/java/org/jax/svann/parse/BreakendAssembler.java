...
public class BreakendAssembler {
    ...
    static Optional<SequenceRearrangement> assembleBreakendRecords(BreakendRecord left, BreakendRecord right) {
        ...
        return Optional.of(SimpleSequenceRearrangement.of(type, adjacency));
    }
     ...
     */
    private static Function<List<BreakendRecord>, Optional<SequenceRearrangement>> assembleEvents() {
        return records -> {
