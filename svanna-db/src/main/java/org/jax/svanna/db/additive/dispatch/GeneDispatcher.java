...
import static org.jax.svanna.db.additive.dispatch.RouteAssemblyUtils.makeAltRouteForBreakendVariant;
...
public class GeneDispatcher implements Dispatcher {
    ...
    private Routes interchromosomalArrangement(GenomicBreakendVariant bv, VariantArrangement arrangement) throws DispatchException {
        ...
        List<Route> alternates = makeAltRouteForBreakendVariant(bv, leftGeneRegion, rightGeneRegion);
