...
public class FantomEnhancerParserTest extends AbstractEnhancerParserTest {
    ...
    public void parse() throws Exception {
        Path countsPath = Paths.get("src/test/resources/enhancer/fantom/F5.hg38.enhancers.expression.matrix.3lines.tsv.gz");
        Path samplesPath = Paths.get("src/test/resources/enhancer/fantom/Human.sample_name2library_id.txt");
