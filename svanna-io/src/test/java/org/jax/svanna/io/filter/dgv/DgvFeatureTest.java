...
public class DgvFeatureTest {
    ...
    public void properties() {
        ...
        DgvFeature feature = DgvFeature.of(chr1, Strand.POSITIVE, CoordinateSystem.oneBased(), 60_901, 71_500, "nsv3324042", VariantType.DUP, 3.f / 14);
    ...
    public void failsWhenFrequencyOutOfBounds() {
        ...
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
                () -> DgvFeature.of(chr1, Strand.POSITIVE, CoordinateSystem.oneBased(), 1, 2,
